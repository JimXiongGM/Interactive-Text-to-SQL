...
COL_VEC_PKL_FILE = "database/cache_vector_db/spider2_sqlite_cols_tb_name_3_large.pkl"
...
def load_all_cols():
    paths = glob("database/cols_info/spider2-sqlite/*.json")
    paths.sort()
...
def vectorization_cols():
    ...
    # chrom
    chroma_client = init_chroma_client(name="spider2-sqlite")
...
if __name__ == "__main__":
    # python preprocess/spider2_sqlite_step3_db_vectorization.py
