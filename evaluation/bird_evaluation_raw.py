...
from tool.utils import round_floats_in_structure

# from: github.com/AlibabaResearch/DAMO-ConvAI/blob/main/bird/llm/src/evaluation.py
...
def execute_sql(predicted_sql, ground_truth, db_path):
    ...
    predicted_res = round_floats_in_structure(predicted_res)
    cursor.execute(ground_truth)
    ground_truth_res = cursor.fetchall()
    ground_truth_res = round_floats_in_structure(ground_truth_res)
    res = 0
...
if __name__ == "__main__":
    ...
    pbar = tqdm(total=len(query_pairs), ncols=100, ascii=" =", disable=True)
    run_sqls_parallel(
        query_pairs,
        db_places=db_paths,
