...
print_yellow "Result of Ours. with_evidence"
...
python -u evaluation/bird_evaluation_raw.py \
    ...
    --predicted_sql_path result/bird/predict/with_evidence/dev.json \
...
python -u evaluation/bird_evaluation_raw.py \
    ...
    --predicted_sql_path result/bird/predict/with_evidence/financial_corrected_original.json \
...
python -u evaluation/bird_evaluation_raw.py \
    ...
    --predicted_sql_path result/bird/predict/with_evidence/financial_corrected_sql.json \
...
python -u evaluation/bird_evaluation_raw.py \
    ...
    --predicted_sql_path result/bird/predict/with_evidence/financial_corrected_data.json \
...
python -u evaluation/bird_evaluation_raw.py \
    ...
    --predicted_sql_path result/bird/predict/with_evidence/minidev_sqlite.json \
