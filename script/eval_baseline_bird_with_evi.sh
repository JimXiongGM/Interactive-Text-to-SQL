...
print_yellow "Baseline of BIRD. no_evidence_False"
...
python -u evaluation/bird_evaluation_raw.py \
    ...
    --predicted_sql_path result/bird/baseline/no_evidence_False/zero_shot_FinancialCorrected-orignal.json \
...
python -u evaluation/bird_evaluation_raw.py \
    ...
    --predicted_sql_path result/bird/baseline/no_evidence_False/zero_shot_FinancialCorrectedSQL.json \
...
python -u evaluation/bird_evaluation_raw.py \
    ...
    --predicted_sql_path result/bird/baseline/no_evidence_False/zero_shot_FinancialCorrected.json \
...
python -u evaluation/bird_evaluation_raw.py \
    --db_root_path dataset/bird/dev_databases/ \
    --ground_truth_path result/bird/golden/financial_corrected_original.sql \
    --predicted_sql_path result/bird/baseline/no_evidence_False/din_sql_FinancialCorrected-orignal.json \
    --diff_json_path dataset/bird-FinC/financial.json \
    --num_cpus $(nproc)
echo "VES"
python evaluation/bird_evaluation_ves_raw.py \
...
python -u evaluation/bird_evaluation_raw.py \
    --db_root_path dataset/bird/dev_databases/ \
    --ground_truth_path result/bird/golden/financial_corrected_sql.sql \
    --predicted_sql_path result/bird/baseline/no_evidence_False/din_sql_FinancialCorrectedSQL.json \
    --diff_json_path dataset/bird-FinC/financial_corrected_sql.json \
    --num_cpus $(nproc)
echo "VES"
python evaluation/bird_evaluation_ves_raw.py \
...
python -u evaluation/bird_evaluation_raw.py \
    --db_root_path dataset/bird/dev_databases/ \
    --ground_truth_path result/bird/golden/financial_corrected_data.sql \
    --predicted_sql_path result/bird/baseline/no_evidence_False/din_sql_FinancialCorrected.json \
    --diff_json_path dataset/bird-FinC/financial_corrected.json \
    --num_cpus $(nproc)
echo "VES"
python evaluation/bird_evaluation_ves_raw.py \
